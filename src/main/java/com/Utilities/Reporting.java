package com.Utilities;
	...
	public class Reporting extends TestListenerAdapter{
		...
		public void onStart(ITestContext testContext) {
			...
			htmlReporter = new ExtentHtmlReporter("D:\\FrameWork\\Reports\\Htmlreports" + resName); // location
																// "./test-												// path to
																												// store the
																												// report
																												// file
			htmlReporter.loadXMLConfig("D:\\FrameWork\\Configurations\\extent-config.xml");
			...
			htmlReporter.config().setDocumentTitle("FrameWork Test Project");// to sent the tile of report
